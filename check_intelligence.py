...
CHECK_INTELLIGENCE = {
    ...
    "LOW_IMAGE_RESOLUTION": {
        ...
        "operational_context": "Una imagen con baja resolución puede verse pixelada, blanda o perder detalle en impresión, especialmente si ocupa un área relevante o corresponde a un elemento crítico del diseño.",
        "possible_impact": "Pérdida visible de calidad, reclamo visual, diferencia contra prueba, rechazo interno, necesidad de reemplazar imagen o retrabajo de preprensa.",
        "fix_type": "assisted",
        "current_limitation": "No distingue completamente el rol de la imagen: producto, fondo, textura, logo, elemento decorativo o zona crítica. Barcode/QR se maneja como riesgo específico cuando aplica.",
        "future_evolution": "Clasificar rol visual de imagen, zona crítica, área afectada y relación con el diseño para ajustar severidad y sugerir reemplazo.",
        "effective_dpi_guidance": "Usar DPI efectivo al tamaño final, no solo resolución nominal del archivo original.",
        "area_guidance": "La severidad debe considerar área afectada. Una imagen pequeña puede ser tolerable; una imagen grande de bajo DPI puede ser crítica.",
        "role_guidance": "Si la imagen corresponde a producto, logo, marca, rostro, texto rasterizado o elemento funcional, el riesgo visual puede ser mayor.",
        "barcode_dedupe_guidance": "Si la imagen de baja resolución parece barcode/QR, debe priorizarse BARCODE_RISK sobre la alerta genérica de baja resolución.",
        "do_not_claim": "Low Image Resolution v1 alerta riesgo técnico de resolución; no certifica calidad visual final ni reemplaza validación humana.",
    },
    "BARCODE_RISK": {
